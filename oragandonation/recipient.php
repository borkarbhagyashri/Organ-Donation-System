...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO requests (user_id, organ_type, blood_group, status) 
            VALUES ('$user_id', '$organ_type', '$blood_group', 'pending')";

    if ($conn->query($sql)) {
        $message = "<div class='success'>Organ request submitted successfully!</div>";
    } else {
